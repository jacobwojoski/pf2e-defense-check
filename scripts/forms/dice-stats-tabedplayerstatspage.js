    ...
    async _handleButtonClick(event){
        ...
        switch(action){
            ...
            case 'd100checkbox':
                ...
                break;
            case 'twod6checkbox':
                DS_GLOBALS.DS_OBJ_GLOBAL.PLAYER_STATS_FORM_DIE_CHECKBOXES[DS_GLOBALS.DIE_TYPE.TWOD6] 
                    = !DS_GLOBALS.DS_OBJ_GLOBAL.PLAYER_STATS_FORM_DIE_CHECKBOXES[DS_GLOBALS.DIE_TYPE.TWOD6];
                DS_GLOBALS.FORM_PLAYER_STATS.render();
                break;
            case 'twod20checkbox':
                DS_GLOBALS.DS_OBJ_GLOBAL.PLAYER_STATS_FORM_DIE_CHECKBOXES[DS_GLOBALS.DIE_TYPE.TWOD20] 
                    = !DS_GLOBALS.DS_OBJ_GLOBAL.PLAYER_STATS_FORM_DIE_CHECKBOXES[DS_GLOBALS.DIE_TYPE.TWOD20];
                DS_GLOBALS.FORM_PLAYER_STATS.render();
                break;
            default:
